package com.kelvin.ecbook.utils;
...
public class ImageUtils {
     ...
     * 显示获取照片不同方式对话框
     */
    public static void showImagePickDialog(final Fragment fragment){
     ...
     * 打开本地相册选取图片
     */
    public static void pickImageFromAlbum(final Fragment fragment){
     ...
     * 打开相机拍照获取图片
     */
    public static void pickImageFromCamera(final Fragment fragment){
    ...
    private static Uri getImageUri(){
        ...
        String path = MyConstant.AvatarDir + imageName;
    ...
    public static void copyImageUri(Activity activity, Uri uri){
        ...
        String imageName = new SimpleDateFormat("yyMMddHHmmss").format(new Date()) + ".jpg";
        String copyPath = MyConstant.AvatarDir + imageName;
     ...
     * 裁剪图片返回
     */
    public static void cropImageUri(Fragment fragment, Uri uri, int outputX, int outputY){
